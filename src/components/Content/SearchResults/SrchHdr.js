...
function SrchHdr(props) {
    ...
    return (
        <div 
        className="srch-author-container">
            <div 
            ...
            alt={props.author}/>
            <h2 
            className="srch-author-container__auth-name">
                {props.author}
            </h2>
...
const MemoSrchHdr = React.memo(SrchHdr, (prevProps, nextProps) => {
    if (prevProps.author === nextProps.author || prevProps.authorDscrpt === nextProps.authorDscrpt)
        {return true}
    return false
})
